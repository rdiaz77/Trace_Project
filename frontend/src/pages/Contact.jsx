          ...
          <TableBody>
            ...
            : contacts
              ...
              >
                ...
                <TableCell>
                  <Button variant="contained" color="primary" size="small" href={`/contacts/${contact.contact_id}`}>
                    See
                  </Button>
                  </TableCell>
                <TableCell>
                  <Button variant="contained" color="secondary" size="small" href={`/contacts/${contact.contact_id}/edit`}>
                    Edit
                  </Button>
                </TableCell>
                <TableCell>
  ...
  return (
    <>
      ...
      <Box sx={{ display: "flex", flexDirection: "row", flexWrap: 'wrap', justifyContent:'space-evenly', p: 3, m:4}}>
        ...
        <Grid>
          <Button variant="contained" href="/contacts/new">Add New Contact</Button>   
        </Grid>

        <Grid>      
          <Button variant="contained" color="success" onClick={handledOnClick}> Show Contact</Button>
        </Grid>
